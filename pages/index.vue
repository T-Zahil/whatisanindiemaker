<template>
  <div class="flex flex-col items-center justify-center max-w-4xl px-4 py-12 mx-auto space-y-24 md:py-24">
    <div
      class="flex flex-wrap items-center justify-center space-x-6 space-y-4 sm:space-y-0 md:fixed top-4 right-4 sm:justify-start">
      ...
      <USelectMenu v-model="locale" :value="currentLocaleObject" :options="availableLocales" value-attribute="code"
        option-attribute="code" icon="i-heroicons-language" @update:model-value="navigateTo(switchLocalePath($event))" />
      ...
      <a href="https://www.buymeacoffee.com/tzahil" rel="noopener" target="_none"
        ...
        <svg class="mr-3" width="11px" height="15px" viewBox="0 0 884 1279" fill="none"
    ...
    <section class="flex flex-col items-center text-center">
      <div
        class="px-10 py-4 transition transform bg-orange-200 border-4 rounded-lg shadow ease hover:rotate-6 border-amber-700 border-opacity-30">
    ...
    <section>
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div
          class="flex flex-col p-10 text-xl text-yellow-800 bg-yellow-200 border-4 border-yellow-800 rounded-lg border-opacity-30">
          ...
          <p>{{ $t('roles.developmentContent') }}</p>
        </div>

        <div
          class="flex flex-col p-10 text-xl text-green-700 bg-green-200 border-4 border-green-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
          ...
          <p>{{ $t('roles.designContent') }}</p>
        </div>

        <div
          class="flex flex-col p-10 text-xl text-red-700 bg-red-100 border-4 border-red-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
          ...
          <p>{{ $t('roles.marketingContent') }}</p>
        </div>

        <div
          class="flex flex-col p-10 text-xl text-purple-700 bg-purple-100 border-4 border-purple-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
          ...
          <p>{{ $t('roles.himselfContent') }}</p>
        </div>

        <div
          class="flex flex-col p-10 text-xl text-indigo-700 bg-indigo-100 border-4 border-indigo-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
          ...
          <p>{{ $t('roles.smContent') }}</p>
        </div>

        <div
          class="flex flex-col p-10 text-xl text-orange-700 bg-orange-100 border-4 border-orange-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
    ...
    <section class="w-full">
      ...
      <div class="flex space-x-2">
        <a v-for="contributor in contributors" :key="contributor.id" :href="contributor.html_url">
