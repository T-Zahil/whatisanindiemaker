<template>
  <div
    class="flex flex-col items-center justify-center max-w-4xl px-4 py-12 mx-auto space-y-24 bg-orange-100 md:py-24"
  >
    <div
    ...
    >
      <a
        href="https://github.com/T-Zahil/whatisanindiemaker"
        rel="noopener"
        target="_none"
      ...
      <a
        href="https://www.buymeacoffee.com/tzahil"
        rel="noopener"
        target="_none"
    ...
    <section>
      <h3
        class="mb-8 text-xl font-semibold text-left md:text-2xl text-amber-800"
      >
        {{ $t('roles.title') }}
      </h3>
