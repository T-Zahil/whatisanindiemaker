  ...
  <div class="flex flex-col items-center justify-center max-w-4xl px-4 py-12 mx-auto space-y-24 bg-orange-100 md:py-24">
    ...
    <section>
      ...
      <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div class="flex flex-col p-10 text-xl text-green-700 bg-green-200 border-4 border-green-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
            <span class="flex items-center justify-center p-2 mr-4 bg-green-300 rounded-full">
        ...
        <div class="flex flex-col p-10 text-xl text-red-700 bg-red-100 border-4 border-red-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
            <span class="flex items-center justify-center p-2 mr-4 bg-red-300 rounded-full">
        ...
        <div class="flex flex-col p-10 text-xl text-purple-700 bg-purple-100 border-4 border-purple-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
            <span class="flex items-center justify-center p-2 mr-4 bg-purple-300 rounded-full">
        ...
        <div class="flex flex-col p-10 text-xl text-indigo-700 bg-indigo-100 border-4 border-indigo-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
            <span class="flex items-center justify-center p-2 mr-4 bg-indigo-300 rounded-full">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-6 h-6"
                viewBox="0 0 24 24"
        ...
        <div class="flex flex-col p-10 text-xl text-orange-700 bg-orange-100 border-4 border-orange-700 rounded-lg border-opacity-30">
          <div class="flex items-center mb-5">
            <span class="flex items-center justify-center p-2 mr-4 bg-orange-300 rounded-full">
