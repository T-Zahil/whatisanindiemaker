...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-keBplOsJ.mjs').then((m) => m.default || m)
  }
];
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><div class="w-full min-h-screen overflow-hidden bg-orange-100 max-w-screen">`);
  _push(ssrRenderComponent(_component_Nuxt, null, null, _parent));
  _push(`<a href="https://www.producthunt.com/posts/what-is-an-indie-maker?utm_source=badge-featured&amp;utm_medium=badge&amp;utm_souce=badge-what-is-an-indie-maker" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=326576&amp;theme=light" alt="What is an Indie Maker? - Are you tired of explaining what an indie maker is? | Product Hunt" style="${ssrRenderStyle({ "width": "250px", "height": "54px" })}" width="250" height="54" class="fixed top-2 left-2"></a></div></div>`);
}
